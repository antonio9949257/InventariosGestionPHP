    ...
    <div class="p-5 mb-5 rounded-3 welcome-header">
        <div class="container-fluid py-5 text-center">
            <h1 class="display-5 fw-bold">
                <img src="<?php echo BASE_URL; ?>img/FARMACORP.png" alt="FarmaCorp Logo" class="main-logo" style="height: 100px; margin-right: 15px; vertical-align: middle;">
                Bienvenido al Inventario de FarmaCorp
            </h1>
